...
const statCards = computed(() => [
  ...
  { label: '知识图谱平均进度', value: overview.value.kg_stats?.avg_percentage !== undefined ? `${overview.value.kg_stats.avg_percentage}%` : '--', icon: SchoolOutline, color: '#10B981' },
])
...
<template>
  <div>
    ...
    <NSpin :show="loading">
      <!-- 统计卡片 -->
      <NGrid :cols="5" :x-gap="24" :y-gap="16" responsive="screen">
