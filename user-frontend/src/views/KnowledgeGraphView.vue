  ...
  <div class="page page--wide">
    ...
    <template v-else>
      <div class="knowledge-card">
        ...
        <div class="graph-panel">
          ...
          <p v-else class="text-text-3 text-center py-12">
            暂无知识图谱数据<br/>
            <RouterLink to="/workflow" class="btn btn--ghost btn--sm" style="margin-top: 12px">去生成学习资源 →</RouterLink>
          </p>
        </div>
      ...
      <div style="display: flex; gap: 12px; justify-content: center; margin-top: 32px">
        <RouterLink to="/resources" class="btn btn--primary btn--lg">去学习资源 →</RouterLink>
        <RouterLink to="/dashboard" class="btn btn--ghost btn--lg">查看学情诊断 →</RouterLink>
      </div>
    </template>
  </div>
</template>
