  ...
  <div class="page page--wide">
    ...
    <template v-else>
      ...
      <div class="report-grid" style="margin-top: 24px">
        ...
        <div class="card">
          ...
          <template v-else>
            ...
            <RouterLink v-if="allCompleted" to="/practice?level=comprehensive" class="btn btn--primary mt-4">进入综合练习</RouterLink>
          </template>
        </div>
      </div>
      ...
      <div class="card" style="margin-top: 24px">
        ...
        <ClientOnly>
          <DifficultyMatchCurve :data="matchCurveData" />
          <template #fallback>
      ...
      <div style="display: flex; gap: 12px; justify-content: center; margin-top: 32px; flex-wrap: wrap">
        <RouterLink to="/knowledge-graph" class="btn btn--ghost btn--lg">查看知识图谱 →</RouterLink>
        <RouterLink to="/resources" class="btn btn--ghost btn--lg">复习学习资源 →</RouterLink>
      </div>
    </template>
  </div>
</template>
...
import DifficultyMatchCurve from '@/components/report/DifficultyMatchCurve.vue'
const api = useApi()
