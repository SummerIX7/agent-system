<template>
  <div class="page page--wide">
      ...
      <div class="card">
        ...
        <div style="display: flex; align-items: center; justify-content: center; padding: 8px 0 4px">
          ...
          <p v-if="knowledgePoints.length === 0" class="text-text-3 text-center py-12">
            暂无诊断数据<br/>
            <RouterLink to="/profile" class="btn btn--ghost btn--sm" style="margin-top: 12px">去创建学习者画像 →</RouterLink>
          </p>
        </div>
      </div>
    ...
    <div style="display: flex; gap: 12px; justify-content: center; margin-top: 32px">
      <RouterLink to="/workflow" class="btn btn--primary btn--lg">生成学习资源→</RouterLink>
    </div>
  </div>
</template>
