    ...
    <section class="page" style="padding-top: 80px; padding-bottom: 60px;">
      <div class="page-head" style="text-align: center; max-width: 640px; margin: 0 auto;">
        ...
        <div style="margin-top: 32px; display: flex; gap: 12px; justify-content: center;">
          <RouterLink to="/profile" class="btn btn--primary btn--lg">开始学习诊断 →</RouterLink>
          <RouterLink to="/workflow" class="btn btn--ghost btn--lg">查看 Agent 协同</RouterLink>
        </div>
      </div>
    </section>
...
import AgentFlowDiagram from '@/components/agent-view/AgentFlowDiagram.vue'
const agents = [
  ...
  { num: '05', name: '试题生成 Agent', desc: '为每个节点生成选择、判断、简答混合练习，并记录答题反馈。' },
...
const steps = [
  ...
  { no: '03', title: '学习与答题', desc: '学习讲义与案例，完成节点练习，获得苏格拉底式追问。' },
